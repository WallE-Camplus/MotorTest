...
class Movement {
  ...
  private:
    Motor *front_left = new Motor(M1_PWM, M1_IN1, M1_IN2);
    Motor *front_right = new Motor(M2_PWM, M2_IN1, M2_IN2);
    Motor *rear_left = new Motor(M3_PWM, M3_IN1, M3_IN2);
    Motor *rear_right = new Motor(M4_PWM, M4_IN1, M4_IN2);
    IMU imu;
